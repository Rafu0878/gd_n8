...
def banner():
	clear()
	sol()
	ban=''' Â© MASTER MIND OF CYBER-404
    __  __ ____    _____ _     _____ ____  _   _  
	 |  \/  |  _ \  | ____| |   | ____/ ___|| | | |/_  (_)
	 | |\/| | |_) | |  _| | |   |  _| \___ \| |_| | / [â€¢] MR RAFU 👨‍💻🧑‍💻
     | |  | |  _ <  | |___| |___| |___ ___) |  _  |/ [â€¢] Facebook: Md. Sabbir Hossain Rafi🙆‍♂️
     |_|  |_|_| \_\ |_____|_____|_____|____/|_| |_|
                                               _/ [â€¢] Master MindðŸ¥ºâ¤ï¸                                      '''
